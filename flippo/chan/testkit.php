...
about us
<br>
<p><i>we may be best friends, ok tysm there will be more information later, alright.</i></p>
<p><u><b>everything is subject to change</b></u></p>
</td>
</tr>
</table>
...
window.onpopstate = function(event) {
    fetch('/testkit' + window.location.pathname + '?ajax=1')
        .then(response => response.text())
